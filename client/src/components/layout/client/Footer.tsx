...
const Footer = ({ mode }: { mode: Mode }) => {
  // Vars
  const footerImageLight = '/images/client/footer-bg-light.png'
  const footerImageDark = '/images/client/footer-bg-dark.png'
      ...
      <div className='bg-[#211B2C] mt-12'>
        ...
        >
          ...
          <div className='flex gap-6 items-center'>
            <IconButton component={Link} size='small' href='https://github.com/miirshe' target='_blank'>
              <i className='tabler-brand-github-filled text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://www.facebook.com/miirshe/' target='_blank'>
              <i className='tabler-brand-facebook-filled text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://x.com/miirshe' target='_blank'>
              <i className='tabler-brand-twitter-filled text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://www.youtube.com/channel/miirshe' target='_blank'>
