...
// SVG Imports
import HubSpot from '@assets/svg/client/landing-page/HubSpot'
import Pinterest from '@assets/svg/client/landing-page/Pinterest'
import Dribbble from '@assets/svg/client/landing-page/Dribbble'
import Airbnb from '@assets/svg/client/landing-page/Airbnb'
import Coinbase from '@assets/svg/client/landing-page/Coinbase'
import Netflix from '@assets/svg/client/landing-page/Netflix'
