...
const pricingPlans = [
  {
    title: 'Basic',
    img: '/images/client/landing-page/pricing-basic.png',
    monthlyPay: 19,
    annualPay: 14,
    perYearPay: 168,
  ...
  {
    title: 'Team',
    img: '/images/client/landing-page/pricing-team.png',
    monthlyPay: 29,
    annualPay: 22,
    perYearPay: 264,
    features: [
  ...
  {
    title: 'Enterprise',
    img: '/images/client/landing-page/pricing-enterprise.png',
    monthlyPay: 49,
    annualPay: 37,
    perYearPay: 444,
    features: [
      ...
      <div className={classnames('is-full', frontCommonStyles.layoutSpacing)}>
        ...
        <div className='flex justify-center items-center max-sm:mlb-3'>
          ...
          <div className='flex gap-x-1 items-start max-sm:hidden mis-2 mbe-5'>
            <img src='/images/client/landing-page/pricing-arrow.png' width='50' />
            ...
            <Grid item key={index} xs={12} lg={4}>
              <Card className={`${plan.current && 'border-2 border-[var(--mui-palette-primary-main)] shadow-xl'}`}>
                <CardContent className='flex flex-col gap-8 p-8'>
                  ...
                  <Button component={Link} href='/client/payment' variant={plan.current ? 'contained' : 'tonal'}>
                    Get Started
                  </Button>
                </CardContent>
              </Card>
