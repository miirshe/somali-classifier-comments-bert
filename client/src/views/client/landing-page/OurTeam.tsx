...
const team = [
  {
    ...
    image: '/images/client/landing-page/miirshe.png',
    color: 'var(--mui-palette-primary-mainOpacity)'
  },
  {
    name: 'Younis Mohamed Abuukar',
    position: 'Full Stack Developer',
  ...
  },
  {
    ...
    image: '/images/client/landing-page/mohamed.png',
                ...
                <CardContent className='flex flex-col items-center justify-center p-0'>
                  ...
                  >
                    <img
                      src={member.image}
                      alt={member.name}
                      className='bs-[240px] absolute block-start-[-50px] rounded-md'
                    />
                  </div>
