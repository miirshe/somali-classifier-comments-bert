...
const GetStarted = ({ mode }: { mode: SystemMode }) => {
  // Vars
  const getStartedImageLight = '/images/client/landing-page/get-started-bg-light.png'
  const getStartedImageDark = '/images/client/landing-page/get-started-bg-dark.png'
    ...
    <section className='relative'>
      ...
      >
        <div className='flex flex-col items-start gap-y-8 gap-x-4 pbs-9 lg:plb-9 z-[1]'>
          ...
          <Button component={Link} href='/client/payment' variant='contained'>
            Get Started
          </Button>
        </div>
        <div className='flex pbs-4 lg:pbs-[60px] md:pie-4 z-[1]'>
          <img
            src='/images/client/landing-page/crm-dashboard.png'
            alt='dashboard-image'
