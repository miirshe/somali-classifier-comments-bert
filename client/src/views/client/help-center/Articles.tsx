...
// SVG Imports
import Gift from '@/assets/svg/client/help-center/Gift'
import Rocket from '@/assets/svg/client/help-center/Rocket'
import File from '@/assets/svg/client/help-center/File'
